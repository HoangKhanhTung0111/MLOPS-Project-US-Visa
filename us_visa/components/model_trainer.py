...
from neuro_mf  import ModelFactory # Used to get the best model using neuro_mf (AutoML library)
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            # Check if best model score is less than expected accuracy, if yes then raise an exception
            if best_model_detail.best_score < self.model_trainer_config.expected_accuracy:
                logging.info("No best model found with score more than base score")
                raise Exception("No best model found with score more than base score")

            # Create an instance of the USvisaModel class with the preprocessor and the best model
